...
class TelegramManagerClient(TelegramClient):
    ...
    def __init__(self, session : str, api_id : int, api_hash : str):
        ...
        Args:
            session: The session name or path
            api_id: The API ID for the Telegram application
            api_hash: The API hash for the Telegram application
        """
    ...
    def start(
        ...
        *,
        ...
        Args:
            phone: A callable that returns the phone number. Defaults to prompting the user.
            password: A callable that returns the password. Defaults to prompting the user.
            bot_token: The bot token if starting a bot session.
            force_sms: Whether to force SMS verification.
            code_callback: A callback function for handling the verification code.
            first_name: The first name of the user.
            last_name: The last name of the user.
            max_attempts: The maximum number of attempts for authentication.
        Returns:
